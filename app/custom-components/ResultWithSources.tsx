...
interface ResultWithSourcesProps {
  messages: Message[];
  pngFile: string;
  maxMsgs?: number;
}

const ResultWithSources: React.FC<ResultWithSourcesProps> = ({
  messages,
  pngFile,
  maxMsgs,
}) => {
  const messagesContainerRef = useRef<HTMLDivElement | null>(null); // Added 'null' as initial value
